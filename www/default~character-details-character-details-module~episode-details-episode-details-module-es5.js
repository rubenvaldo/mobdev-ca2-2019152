...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~character-details-character-details-module~episode-details-episode-details-module"], {
  /***/
  ...
  function srcAppServicesFavouriteServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! @ionic/storage */
    "./node_modules/@ionic/storage/fesm2015/ionic-storage.js"); // Reference from: https://mikhail-cct.github.io/mobdev/wk7/#/7


    var FAV_EP = 'favouriteEpisodes';
    var FAV_CHAR = 'favouriteCharacters'; //const UNFAV_EP = 'unfavouriteEpisodes';
    //const UNFAV_CHAR = 'unfavouriteCharacters';

    var FavouriteService = /*#__PURE__*/function () {
      function FavouriteService(storage, storageChar) {
        _classCallCheck2(this, FavouriteService);

        this.storage = storage;
        this.storageChar = storageChar;
      } // === EPISODES ===
        ...
        value: function favouriteEpisode(episodeId) {
          ...
          return this.getAllFavouriteEpisodes().then(function (result) {
            if (result) {
              ...
              return _this3.storage.set(FAV_EP, result);
            } else {
              return _this3.storage.set(FAV_EP, [episodeId]);
            }
          });
        }
      }, {
        ...
        value: function unfavouriteEpisode(episodeId) {
          ...
          return this.getAllFavouriteEpisodes().then(function (result) {
            if (result) {
              ...
              return _this4.storage.set(FAV_EP, result);
            }
          });
        } // ==== CHARACTERS ===
        ...
        value: function favouriteCharacter(characterId) {
          ...
          return this.getAllFavouriteCharacters().then(function (result) {
            if (result) {
              ...
              return _this5.storageChar.set(FAV_CHAR, result);
            } else {
              return _this5.storageChar.set(FAV_CHAR, [characterId]);
            }
          });
        }
      }, {
        ...
        value: function unfavouriteCharacter(characterId) {
          ...
          return this.getAllFavouriteCharacters().then(function (result) {
            if (result) {
              ...
              result.splice(index, 1);
              return _this6.storageChar.set(FAV_CHAR, result);
            }
          });
        }
      }]);
    ...
    FavouriteService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_storage__WEBPACK_IMPORTED_MODULE_2__["Storage"], _ionic_storage__WEBPACK_IMPORTED_MODULE_2__["Storage"]])], FavouriteService);
    /*
...
//# sourceMappingURL=default~character-details-character-details-module~episode-details-episode-details-module-es5.js.map